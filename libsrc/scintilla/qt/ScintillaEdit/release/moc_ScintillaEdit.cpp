...
static constexpr auto qt_meta_stringdata_ZN13ScintillaEditE = QtMocHelpers::stringData(
    "ScintillaEdit"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13ScintillaEditE[] = {
...
Q_CONSTINIT const QMetaObject ScintillaEdit::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13ScintillaEditE.offsetsAndSizes,
    qt_meta_data_ZN13ScintillaEditE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13ScintillaEditE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ScintillaEdit, std::true_type>
    >,
    nullptr
} };
...
void *ScintillaEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13ScintillaEditE.stringdata0))
