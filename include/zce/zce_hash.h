...
zce_byte* ZCE_API zce_hmac_sha1(zce_byte out[20], const zce_byte* msg, size_t msglen,
                                const zce_byte* secret, size_t secretlen);
...
zce_byte* ZCE_API zce_hmac_sha256(zce_byte out[32], const zce_byte* msg, size_t msglen,
                                  const zce_byte* secret, size_t secretlen);
