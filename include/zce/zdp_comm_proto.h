...
namespace zdp_comm
{
    ...
    struct ua_basic_t
    {
        ...
        zce_tstring userid/*编号*/;
        zce_tstring sid/*会话IDSessionID*/;
        zce_tstring nick/*昵称*/;
        zce_tstring image/*头像*/;
        zce_tstring cell/*手机*/;
        zce_tstring sign/*个性签名*/;
        zce_tstring memo/*备注，多对多*/;
        zce_tstring randstr/*保留字符串*/;
    };
    struct notify_t
    {
