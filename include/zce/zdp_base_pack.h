...
namespace zce
{
    namespace zdp
    {
        ...
        int zds_pack(zce_byte* buf, int size, const zdp_base::logtext_t& _t, zds_context_t* ctx, bool has_prefix);
        int zds_unpack(zdp_base::logtext_t& _t, const zce_byte* buf, int size, zds_context_t* ctx, bool has_prefix);
