#pragma once
// ***************************************************************
//  zce::CharacterConvertor   version:  1.0  date: 2007-12-21
//  -------------------------------------------------------------
...
class ZCE_API CharacterConvertor {
    bool swap_;
  ...
  public:
    ...
    CharacterConvertor(bool swap = false) : swap_(swap) {};
    static int gb2312_to_utf8(const char* source, size_t source_size, unsigned char* target,
                              size_t target_size, bool strict = true);
    static int utf8_to_gb2312(const unsigned char* source, size_t source_size, char* target,
                              size_t target_size, bool strict = true);
    static int wchart_to_gb2312(const wchar_t* source, size_t source_size, char* target,
                                size_t target_size);
