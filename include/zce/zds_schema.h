...
enum ERV_ZDS_SUBTYPE : zce_byte {
    ...
    ZDS_SUBTYPE_VEC,     // vector item
    ZDS_SUBTYPE_MAT,     // matrix item
};
...
template <typename T>
struct is_builtin_vector<std::vector<T>>
...
constexpr bool is_builtin_type() {
    ...
    return is_builtin_basic<T>::value || is_builtin_vector<T>::value ||
           (std::is_pointer<decayed_type>::value &&
            is_builtin_basic<typename std::remove_pointer<decayed_type>::type>::value) ||
           (std::is_array<decayed_type>::value &&
            is_builtin_basic<typename std::remove_extent<decayed_type>::type>::value);
}
...
int ZCE_API zds_pack_builtin(zce_byte* buf, zce_int32 size, const void* val, zds_context_t* ctx,
...
#define DECLARE_PACK_BUILTIN_ARRAY(TT)                                                            \
    int ZCE_API zds_pack_builtin(zce_byte* buf, zce_int32 size, const std::vector<TT>& val,       \
                                 zds_context_t* ctx, bool has_prefix = true);                     \
    int ZCE_API zds_pack_builtin(zce_byte* buf, zce_int32 size, const TT* vec, unsigned vec_size, \
                                 zds_context_t* ctx, bool has_prefix = true,                      \
                                 bool skip_content = false);

int ZCE_API zds_pack_builtin(zce_byte* buf, zce_int32 size, const std::vector<bool>& val,
                             zds_context_t* ctx, bool has_prefix = true);
...
int ZCE_API zds_pack_builtin(zce_byte* buf, zce_int32 size, const char* val, zds_context_t* ctx,
                             bool has_prefix = true, bool skip_content = false);

int ZCE_API zds_pack_builtin(zce_byte* buf, zce_int32 size, const std::string& val,
                             zds_context_t* ctx, bool has_prefix = true, bool skip_content = false);

int ZCE_API zds_pack_builtin(zce_byte* buf, zce_int32 size, const zce::string_view& val,
                             zds_context_t* ctx, bool has_prefix = true, bool skip_content = false);
...
int ZCE_API zds_pack_struct_array_header(zce_byte* buf, int size, zce_uint64 array_size,
                                         zds_context_t* ctx, bool has_prefix = true);
...
int ZCE_API zds_unpack_builtin(zce_int64& val, const zce_byte* buf, zce_int32 size,
                               zds_context_t* ctx);

int ZCE_API zds_unpack_builtin(zce_float& val, const zce_byte* buf, zce_int32 size,
                               zds_context_t* ctx);

int ZCE_API zds_unpack_builtin(zce_double& val, const zce_byte* buf, zce_int32 size,
                               zds_context_t* ctx);
...
int ZCE_API zds_unpack_builtin(std::vector<bool>& val, const zce_byte* buf, zce_int32 size,
                               zds_context_t* ctx);

int ZCE_API zds_unpack_builtin(std::vector<zce_byte>& val, const zce_byte* buf, zce_int32 size,
                               zds_context_t* ctx);

int ZCE_API zds_unpack_builtin(std::vector<zce_uint16>& val, const zce_byte* buf, zce_int32 size,
                               zds_context_t* ctx);

int ZCE_API zds_unpack_builtin(std::vector<zce_uint32>& val, const zce_byte* buf, zce_int32 size,
                               zds_context_t* ctx);
...
int ZCE_API zds_unpack_builtin(std::vector<zce_int32>& val, const zce_byte* buf, zce_int32 size,
                               zds_context_t* ctx);

int ZCE_API zds_unpack_builtin(std::vector<zce_int64>& val, const zce_byte* buf, zce_int32 size,
                               zds_context_t* ctx);

int ZCE_API zds_unpack_builtin(std::vector<zce_float>& val, const zce_byte* buf, zce_int32 size,
                               zds_context_t* ctx);
...
int ZCE_API zds_unpack_struct_array_header(zce_uint64& val, const zce_byte* buf, int size,
                                           zds_context_t* ctx);
