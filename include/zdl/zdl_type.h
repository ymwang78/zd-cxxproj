...
enum yytokentype
{
    ...
    ZDL_ANY = 276,                /* ZDL_ANY  */
    ZDL_ENUM = 277,               /* ZDL_ENUM  */
    ZDL_STRUCT = 278,             /* ZDL_STRUCT  */
    ZDL_NAMESPACE = 279,          /* ZDL_NAMESPACE  */
    ZDL_IDENTIFIER = 280,         /* ZDL_IDENTIFIER  */
    ZDL_INTEGER_LITERAL = 281,    /* ZDL_INTEGER_LITERAL  */
    ZDL_DOUBLE_LITERAL = 282,     /* ZDL_DOUBLE_LITERAL  */
    ZDL_STRING_LITERAL = 283,     /* ZDL_STRING_LITERAL  */
    ZDL_COMMENT = 284,            /* ZDL_COMMENT  */
    ZDL_USER_START = 285          /* ZDL_USER_START  */
};
