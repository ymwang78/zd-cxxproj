...
enum yytokentype {
    ...
    ZDL_ANY = 273,             /* ZDL_ANY  */
    ZDL_DBLMAT = 274,          /* ZDL_DBLMAT  */
    ZDL_FLTMAT = 275,          /* ZDL_FLTMAT  */
    ZDL_ENUM = 276,            /* ZDL_ENUM  */
    ZDL_STRUCT = 277,          /* ZDL_STRUCT  */
    ZDL_NAMESPACE = 278,       /* ZDL_NAMESPACE  */
    ZDL_IDENTIFIER = 279,      /* ZDL_IDENTIFIER  */
    ZDL_INTEGER_LITERAL = 280, /* ZDL_INTEGER_LITERAL  */
    ZDL_DOUBLE_LITERAL = 281,  /* ZDL_DOUBLE_LITERAL  */
    ZDL_STRING_LITERAL = 282,  /* ZDL_STRING_LITERAL  */
    ZDL_COMMENT = 283,         /* ZDL_COMMENT  */
  ...
  public:
    ...
    const char* fetch_meta(const std::string& key, const char* def = NULL) const {
        std::vector<std::pair<std::string, std::string> >::const_iterator iter = std::find_if(
            vec_metas_.begin(), vec_metas_.end(), [key](auto iter) { return iter.first == key; });
        if (iter == vec_metas_.end()) return def;
...
class zdl_type : public meta_base {
  ...
  public:
    ...
    inline const std::string& name() const noexcept { return type_name_; };
    ...
    inline zdl_type_e type_e() const noexcept { return get_type_e(type_id_); };

    inline bool is_struct() const noexcept { return type_e() == type_struct_e; }
